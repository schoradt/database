...
echo -e "================================="
psql -p $port -U $user -d $database -1 -f "schema/trunk/constraint_helper_functions.sql"


echo -e "\ninstall constraint check functions"
echo -e "================================"
psql -p $port -U $user -d $database -1 -f "schema/trunk/constraint_check_functions.sql"


echo -e "\ninstall constraints"
echo -e "================="
psql -p $port -U $user -d $database -1 -f "schema/trunk/constraint_main.sql"


# install public functions
echo -e "\n\ninstall public functions"
echo -e "========================"
psql -p $port -U $user -d $database -1 -f "schema/trunk/public_functions.sql"


# install meta database
echo -e "\n\ninstall schema for meta database"
echo -e "================================"
psql -p $port -U $user -d $database -1 -f "schema/trunk/meta_database_schema.sql"

echo -e "\n\ninstall data for meta database"
echo -e "=============================="
psql -p $port -U $user -d $database -1 -f "data/trunk/meta_data.sql" -q


#install file schema
echo -e "\n\ninstall schema for file service"
echo -e "==============================="
psql -p $port -U $user -d $database -1 -f "schema/trunk/file_schema.sql"


# install schema for role based access control
echo -e "\n\ninstall schema for role based access control"
echo -e "============================================"
psql -p $port -U $user -d $database -1 -f "schema/trunk/rbac_schema.sql"

echo -e "\n\ninstall data for meta database"
echo -e "=============================="
psql -p $port -U $user -d $database -1 -f "data/trunk/rbac_data.sql" -q


# install system database and add content
echo -e "\n\ninstall schema for system database"
echo -e "=================================="
psql -p $port -U $user -d $database -1 -f "schema/trunk/system_schema.sql"

echo -e "\n\ninstall system trigger"
echo -e "======================"
psql -p $port -U $user -d $database -1 -f "schema/trunk/system_trigger.sql"

echo -e "\n\ninstall static value lists"
echo -e "=========================="
psql -p $port -U $user -d $database -q -1 -f "data/trunk/system_static_valuelist.sql" -q

echo -e "\n\ninstall initial topic framework"
echo -e "==============================="
psql -p $port -U $user -d $database -q -1 -f "data/trunk/system_initial_topic_framework.sql" -q


# install baalbek
echo -e "\n\ninstall schema for project database"
echo -e "==================================="
psql -p $port -U $user -d $database -1 -f "schema/trunk/project_schema.sql"

echo -e "\n\ninstall project trigger"
echo -e "======================="
psql -p $port -U $user -d $database -1 -f "schema/trunk/project_trigger.sql"

echo -e "\n\ninstall baalbek geometry settings"
echo -e "================================="
psql -p $port -U $user -d $database -1 -f "data/trunk/project_baalbek_geom_settings.sql" -q

echo -e "\n\ninstall baalbek data"
echo -e "===================="
pg_restore -p $port -U $user -d $database --disable-triggers "data/trunk/project_baalbek_dump"

echo -e "\n\ninstall baalbek meta data"
echo -e "========================="
psql -p $port -U $user -d $database -1 -f "data/trunk/project_baalbek_meta_data.sql" -q
...
echo -e "========================="
psql -p $port -U $user -d $database -1 -f "schema/trunk/project_indices.sql" -q
...
echo -e "===================="
pg_restore -p $port -U $user -d $database --disable-triggers "data/trunk/project_palatin_dump"
...
echo -e "\n\ninstall test data"
echo -e "================="
psql -p $port -U $user -d $database -1 -f "data/trunk/project_static_valuelist.sql" -q
psql -p $port -U $user -d $database -1 -f "data/trunk/test.sql" -q
